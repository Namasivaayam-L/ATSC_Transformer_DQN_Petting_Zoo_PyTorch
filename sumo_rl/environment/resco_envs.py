...
def grid4x4(parallel=True, **kwargs):
    ...
    """
    kwargs.setdefault("num_seconds", 3600)
    kwargs.update(
        {
...
def cologne1(parallel=True, **kwargs):
    ...
    Number of actions: 4
    """
    kwargs.setdefault("begin_time", 25200)
    kwargs.setdefault("num_seconds", 28800 - 25200)
    kwargs.update(
        {
...
def ingolstadt1(parallel=True, **kwargs):
    ...
    Number of actions: 3
    """
    kwargs.setdefault("begin_time", 57600)
    kwargs.setdefault("num_seconds", 61200 - 57600)
    kwargs.update(
        {
